...
interface TempWatchDataProps extends TempMovieDataProps {
  runtime: number;
  imdbRating: number;
  userRating: number;
}
...
const WatchedMovieList: React.FC<WatchedMovieListProps> = ({ watched }) => {
  return (
    <ul className='list'>
      {watched.map((movie) => (
